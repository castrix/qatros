    ...
    switch(i){
      ...
      case "del":
        ...
        if(this.state.current !== ""){
          ...
          this.setState({...this.state, current:this.state.ivalue[this.state.ivalue.length-1].substr(0,this.state.ivalue[this.state.ivalue.length-1].length-1), ivalue:this.state.ivalue.filter((item,index)=> index !== this.state.ivalue.length-1)});
        }
        break;
      default:
        this.state.current !== "" &&
